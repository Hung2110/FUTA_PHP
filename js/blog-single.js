document.addEventListener('DOMContentLoaded', function() {
    // Biến `currentUrl` và `postTitle` được lấy từ thẻ script trong file PHP
    ...
    if (zaloBtn) {
        zaloBtn.href = `https://sp.zalo.me/share_inline?url=${encodeURIComponent(currentUrl)}&title=${encodeURIComponent(postTitle)}`;
    }
