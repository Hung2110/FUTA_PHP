    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="project.php">Dự án</a></li>
            ...
            <div class="col-lg-8">
                <div class="main-content-wrapper">
                    ...
                    <div class="project-meta">
                        <span><i class="fas fa-building"></i> <strong>Khách hàng:</strong> <?php echo htmlspecialchars($project['client']); ?></span>
