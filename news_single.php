...
if ($result->num_rows === 0) {
    ...
    echo "<div class='container my-5 text-center'><h1>Bài viết không tồn tại hoặc đã bị xóa.</h1><a href='news.php' class='btn btn-primary mt-3'>Quay lại trang Tin Tức</a></div>";
            ...
            <div class="col-lg-8">
                <div class="main-content-wrapper">
                    ...
                    <div class="project-meta">
                        ...
                        <span><i class="fas fa-calendar-alt"></i> <strong>Ngày đăng:</strong> <?php echo date('d/m/Y', strtotime($post['created_at'])); ?></span>
                        <?php if(!empty($post['author'])): ?>
                            <span class="ms-3"><i class="fas fa-user"></i> <strong>Tác giả:</strong> <?php echo htmlspecialchars($post['author']); ?></span>
                        <?php endif; ?>
                    </div>
